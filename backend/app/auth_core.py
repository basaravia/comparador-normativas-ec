...
# Sin usuario por defecto: el repositorio es público y no debe llevar una identidad real ni
# un usuario adivinable. Sin AUTH_USERNAME el login queda cerrado (ver credentials_are_configured).
DEFAULT_USERNAME = ""
