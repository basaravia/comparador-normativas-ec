...
BACKEND_ROOT = Path(__file__).resolve().parent.parent  # el código vive en backend/, los assets en la raíz
THEME_PATH = BACKEND_ROOT / "app" / "theme.py"
COMPARATOR_PATH = BACKEND_ROOT / "src" / "comparator.py"
